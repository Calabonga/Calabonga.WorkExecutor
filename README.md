...
```
git clone https://gitflic.ru/project/calabonga/calabongaworkexecutor.git
cd calabongaworkexecutor
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/calabonga/calabongaworkexecutor.git
git clone
